...
const Register = () => {
    const { CreateEmailConfirmationRequest } = useRegister()
        ...
        >
            ...
            >
                            ...
                            <For each={[
                                ...
                                {(item) =>
                                    <Field key={item.id} label={item.label} required={item.required} marginBottom={"20px"} width={"100%"}>
                                        <item.input _focus={{ border: "2px solid teal", outline: "none" }} onChange={(e) => handlingInput(e, item.labelJSON)} />
                                    </Field>
                                }
                            </For>
                            <For each={[
                ...
                <Button
                    ...
                    onClick={() => {
                        CreateEmailConfirmationRequest(dataEmail, dataRegister);
