import { Box, Flex, Input, Button, Link, Text, For, SelectPositioner } from "@chakra-ui/react"
import { PasswordInput } from "@/components/ui/password-input"
import { Field } from "@/components/ui/field"
import { useNavigate } from "react-router-dom"
import { useEffect, useState } from "react"
import { useLogin } from "@/fetchRequest/allFetch"
                ...
                <For each={[
                    ...
                    {(item) =>
                        <Field key={item.id} label={item.label} required marginBottom={"20px"}>
                            <item.input
                                _focus={{ border: "2px solid teal", outline: "none" }}
